...
func (record *Report_Store) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func postGetList(recordList *[]Report_Store) ([]Report_Store, error) {
	clock := timing.Start(domain, actions.PROCESS.GetCode(), "POSTGET")
	returnList := []Report_Store{}
...
func (record *Report_Store) postGet() error {
...
func (record *Report_Store) checkForDuplicate() error {
